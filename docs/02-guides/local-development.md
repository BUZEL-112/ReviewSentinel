...
If you are just getting started, see [Getting Started](../02-guides/local-development.md#getting-started) for the initial setup steps.
...
See [Troubleshooting](../05-operations/troubleshooting.md) for full details on common Docker issues, including:
